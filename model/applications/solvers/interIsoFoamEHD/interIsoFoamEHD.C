...
-------------------------------------------------------------------------------
	...
	Copyright (C) 2021 Silvio Candido
-------------------------------------------------------------------------------
License
...
Description
    ...
    adaptive re-meshing. Including effect of Electric Fields.
...
int main(int argc, char *argv[])
{
    ...
    while (runTime.run())
    {
        ...
        while (pimple.loop())
        {
            ...
            #include "ElectricEqn.H"	//  ---  INCLUDE ELECTRIC EQUATION 
            mixture.correct();

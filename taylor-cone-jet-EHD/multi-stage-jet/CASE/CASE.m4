...
define(de, 		calc((Dout-Din)/2)) // Outlet Dimension
define(He, 		calc(H+de))   		// Height (from tip nozzle to extraction plate)
define(Hd, 		calc(He+(1)))   	// Height (from tip nozzle to acceleration plate)
